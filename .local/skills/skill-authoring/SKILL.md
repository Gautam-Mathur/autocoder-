...
2. Write the SKILL.md file to `~/.agent/skills/SKILLNAME/SKILL.md`
...
- **`~/.agent/skills/`** - User and agent-editable skills. Create new skills here. These can be freely modified, updated, and deleted.
...
- **Use separate files for large content**: Organize reference material in folders (e.g., `~/.agent/skills/SKILLNAME/reference/api.md`) and link to it from SKILL.md
- **Skills can be updated**: Skills in `~/.agent/skills/` are mutable. Update them as you discover better patterns—don't treat them as permanent. Iterate as the user's needs evolve
